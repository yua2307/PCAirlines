                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="<c:url value="/admin/addAircraft"/>">Thêm Máy Bay</a>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <mvc:form method="POST" action="addAircraftProcess" modelAttribute="aircraft" id="subscribe_frm">
                            ...
                            <mvc:button>Thêm máy bay</mvc:button>
                        </mvc:form>
                        <br>
                        <table  class="table table-striped table-bordered">
                            ...
                            <c:forEach var="aircraft" items="${pagedListHolder.pageList}">
                                <tr>
                                    ...
                                    <td>${aircraft.airlineBrand.getBrandName()}</td>
                                    <td>${aircraft.model}</td>
                                    <td>${aircraft.seatNumber}</td>
                                </tr>
                            </c:forEach>
                            </table>
                        <c:url value="/admin/addAircraft" var="pagedLink">
