                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="<c:url value="/admin/allCustomer"/>">Liệt kê khách hàng</a>
                        </div>
                    </div>
                </li>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <!-- Topbar Search -->
                        <mvc:form action="searchCustomer" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group">
                                <input name="term" type="text" class="form-control bg-light border-0 small" placeholder="Search By Name ..... " aria-label="Search" >
                                <div class="input-group-append">
                                   <button class="btn btn-primary" >
                                        <i class="fas fa-search fa-sm"></i>
                                    </button>
                                    
                                    <a href="<c:url value="/admin/allCustomer" />"><i class="fa" style="font-size:24px; margin: 8px 8px 7px 15px;">&#xf021;</i></a>
                                </div>
                            </div>
                        </mvc:form>
                    ...
                    <div class="container-fluid">
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                ...
                                <c:forEach var="customer" items="${pagedListHolder.pageList}">
                                    <c:url var="lockLink" value="lockCustomer">
                                        <c:param name="customerID" value="${customer.customerId}" />
                                    </c:url>
                                    <c:url var="unlockLink" value="unlockCustomer">
                                        <c:param name="customerID" value="${customer.customerId}" />
                                    </c:url>
                                    <tr>
                                        <td>${customer.name}</td>
                                        <td>${customer.phoneNumber}</td>
                                        <td>${customer.identifyNumber}</td>
                                        <td>${customer.email}</td>
                                        <td>${customer.address}</td>
                                         <c:choose>
                                             <c:when test="${customer.enabled == true}">
                                                 <td>
                                                     <p style="color:lightgreen;">Enabled</p>
                                                 </td>
                                                 <td>
                                                      
                                                <a href="${lockLink}" onclick="if (!(confirm('Are you sure want to lock this customer?')))
                                                            return false">
                                             ...
                                             <c:otherwise>
                                                 ...
                                                 <td> 
                                                <a href="${unlockLink}" onclick="if (!(confirm('Are you sure want to unlock this customer?')))
                                                            return false">
                        ...
                        <c:url value="/admin/allCustomer" var="pagedLink">
