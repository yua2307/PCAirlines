        ...
        <div id="wrapper">
                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="<c:url value="/admin/addAdmin"/>">Thêm người quản lý</a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <!-- Begin Page Content -->
                    <h3 style="margin: 0px 0px 15px 460px;

                        top: 13%;
                        transform: translateY(-50%);">Thêm quản lí</h3>
                    <mvc:form action="addAdminProcess" method="POST" modelAttribute="customer" class="needs-validation">

                        <div class="container-fluid">
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom01">Tên đẩy đủ</label>
                                    <mvc:input path="name" type="text" class="form-control" id="validationCustom01" required="required"/>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom02">SĐT</label>
                                    <mvc:input path="phoneNumber" type="tel"  class="form-control" id="validationCustom02" required="required"/>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom03">Địa chỉ</label>
                                    <mvc:input type="text" path="address" class="form-control" id="validationCustom03" required="required"/>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="validationCustom04">Địa chỉ Email </label>
                                    <mvc:input type="email" path="email" class="form-control" id="validationCustom03" required="required"/>
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="validationCustom03">Chứng minh nhân dân</label>
                                    <mvc:input type="text" path="identifyNumber" class="form-control" id="validationCustom03" required="required"/>
                                </div>
                            ...
                            <div class="form-row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <mvc:input path="username" type="text" class="form-control" id="validationCustom01" required="required"/>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="validationCustom02">Mật khẩu</label>
                                    <mvc:input path="password" type="password"  class="form-control" id="validationCustom02" required="required"/>
                                </div>
                            </div>
                            <mvc:button style="margin: 20px 0px 0px 490px;" class="btn btn-primary" type="submit">Thêm</mvc:button>
                            <h3 style="margin: 20px 0px 0px 350px;"> ${exist}</h3>
                            </div>
                            <!-- /.container-fluid -->
                    </mvc:form>
                </div>
