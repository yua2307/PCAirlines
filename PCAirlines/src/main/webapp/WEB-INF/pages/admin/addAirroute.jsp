                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="<c:url value="/admin/addAirroute"/>">Thêm Tuyến Bay</a>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <mvc:form method="POST" action="addAirrouteProcess" modelAttribute="flightRoute" id="subscribe_frm">
                                    ...
                                    <td>
                                        <mvc:select path="departurePlace">
                                            <c:forEach items="${airportList}" var="tempAirport"> 
                                                <mvc:option value="${tempAirport.getAirportId()}">${tempAirport.getCityName()}</mvc:option>
                                            </c:forEach>
                                        </mvc:select>
                                    </td>
                                </tr>
                            ...
                            <mvc:button>Thêm tuyến bay</mvc:button>
                        </mvc:form>
                        <br>
                        <table class="table table-striped table-bordered">
                            ...
                            <c:forEach var="route" items="${pagedListHolder.pageList}">
                                <tr>
                                    <td>${route.departurePlace.getCityName()}</td>
                                    <td>${route.arrivalPlace.getCityName()}</td>
                                    <td><fmt:formatNumber currencySymbol="VNĐ" minFractionDigits="0" value = "${route.standardPrice}" type = "currency" /></td>
                                </tr>
                            </c:forEach>
                        </table>
                         <c:url value="/admin/addAirroute" var="pagedLink">
