                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="<c:url value="/admin/addFlight"/>">Thêm Chuyến Bay</a>
                        </div>
                    </div>
                </li>
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        <mvc:form method="POST" action="addFlightProcess" modelAttribute="flight" id="subscribe_frm">
                                    ...
                                    <td>
                                        <mvc:select path="flightRoute">
                                            <c:forEach items="${flightRouteList}" var="tempFlightRoute"> 
                                                <mvc:option value="${tempFlightRoute.getRouteID()}">${tempFlightRoute.getDeparturePlace().getCityName()}-${tempFlightRoute.getArrivalPlace().getCityName()}</mvc:option>
                                            </c:forEach>
                                        </mvc:select>
                                    </td>
                                </tr>
                            ...
                            <mvc:button>Thêm chuyến bay</mvc:button>
                        </mvc:form>
                        <br>
                        <table class="table table-striped table-bordered">
                            ...
                            <c:forEach var="flight" items="${pagedListHolder.pageList}">
                                <tr>
                                    <td>${flight.flightRoute.getDeparturePlace().getCityName()}</td>
                                    <td>${flight.flightRoute.getArrivalPlace().getCityName()}</td>
                         ...
                         <c:url value="/admin/addFlight" var="pagedLink">
