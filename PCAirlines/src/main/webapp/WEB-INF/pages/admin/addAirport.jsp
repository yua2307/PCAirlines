                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseTwo" class="collapse show" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="<c:url value="/admin/addAirport"/>">Thêm Sân Bay</a>
                    ...
                    <div class="container-fluid">
                        ...
                        <div id="form_container">
                            <mvc:form method="POST" action="addAirportProcess" modelAttribute="airport" id="subscribe_frm">
                                ...
                                <mvc:button>Thêm Sân Bay</mvc:button>
                            </mvc:form>
                        </div>
                        <br>    
                        <table class="table table-striped table-bordered">
                            ...
                            <c:forEach var="airport" items="${pagedListHolder.pageList}">
                                <tr>
                         ...
                         <c:url value="/admin/addAirport" var="pagedLink">
