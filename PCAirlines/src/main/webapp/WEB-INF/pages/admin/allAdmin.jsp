                ...
                <li class="nav-item active">
                    ...
                    <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item active" href="<c:url value="/admin/allAdmin"/>">Liệt kê quản lí</a>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                        ...
                        <!-- Topbar Search -->
                        <mvc:form action="searchAdmin" method="GET" class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search">
                            <div class="input-group">
                                <input name="term" type="text" class="form-control bg-light border-0 small" placeholder="Search By Name ..... " aria-label="Search" aria-describedby="basic-addon2">
                    ...
                    <!-- End of Topbar -->
                    <h3 style="margin: 0px 0px 0px 460px;

                        top: 13%;
                        transform: translateY(-50%);">Liệt kê quản lí</h3>
                    <!-- Begin Page Content -->
                    <div class="container-fluid">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <c:forEach var="admin" items="${pagedListHolder.pageList}">
                                <tr>
                                    <td>${admin.name}</td>
                                    <td>${admin.phoneNumber}</td>
                                    <td>${admin.identifyNumber}</td>
                                    <td>${admin.email}</td>
                                    <td>${admin.address}</td>
                                </tr>
                                </c:forEach>
